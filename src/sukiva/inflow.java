 ...
 * @author Snake_Eye
 */
public class inflow extends javax.swing.JInternalFrame {
DefaultTableModel defaultTableModel = new DefaultTableModel();
    ...
    public inflow() {
        ...
        tbdes.setBackground(new java.awt.Color(0,0,0,1));
         ...
         is.setBackground(new java.awt.Color(0,0,0,1));
       is.getViewport().setBackground(new java.awt.Color(0,0,0,1));
     it.setBackground(new java.awt.Color(0,0,0,1));

         
        JTableHeader header = it.getTableHeader();
        header.setEnabled(false);
     header.setBackground(new java.awt.Color(0,0,0,0));
       it.getTableHeader().setFont(new Font("Times New Roman", Font.BOLD, 14));
   ...
   it.setDefaultEditor(Object.class, null);
    ...
    private void initComponents() {
        ...
        is = new javax.swing.JScrollPane();
        ...
        is.setViewportView(it);

        getContentPane().add(is, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 0, 570, 530));
    ...
    private javax.swing.JScrollPane is;
